...
describe('roundValue', () => {
  it('should return input when no other arguments are specified', () => {
  ...
  it('should cast value to integer', () => {
  ...
  it('should clamp value to min and max and rounds value to step', () => {
